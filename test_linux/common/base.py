...
class Base(object):
    ...
    def is_title_equals(self, _title):
        try:
            r = WebDriverWait(self.driver, self.timeout, self.t).until(EC.title_is(_title))
            return r
        except:
            return False
    ...
    def is_title_contains(self, _title):
        try:
            r = WebDriverWait(self.driver, self.timeout, self.t).until(EC.title_contains(_title))
            return r
        except:
            return False
    ...
    def is_ele_text_contains(self, locator, _text):
        try:
            r = WebDriverWait(self.driver, self.timeout, self.t).until(EC.text_to_be_present_in_element(locator, _text))
            return r
        except:
            return False
    ...
    def is_ele_value_contains(self, locator, _text):
        try:
            r = WebDriverWait(self.driver, self.timeout, self.t).until(EC.text_to_be_present_in_element_value(locator, _text))
            return r
        except:
            return False
